...
const Header = () => {
  ...
  return (
    <div className="d-flex justify-content-between align-items-md-center pb-3 mb-5 border-bottom">
      <h1 className="h4">
        <Link
          to="/"
        ...
        >
          <svg
            ...
            height="32"
            fill="currentColor"
            className="bi bi-cake d-inline-block me-2"
            viewBox="0 0 16 16"
          >
